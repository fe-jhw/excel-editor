...
export const getOrElseFromUndefined = <A>(a: A | undefined, defaultValue: A): A => {
  return getOrElse(fromUndefined(a), defaultValue)
}

export const getOrElseFromNull = <A>(a: A | null, defaultValue: A): A => {
  return getOrElse(fromNull(a), defaultValue)
}
